    ...
    .then(function () {
      return knex('family').insert([
        ...
        },
        {
          ...
          husband_image: '../image/dad3',
          wife_name: 'Nina Sky',
          wife_birthday: '08-10-1999',
          wife_POB: 'Las Vegas, USA',
          wife_image: '../image/mom3',
          kid1_name: 'Kayla Velez',
